...
const TimeFrames = ({
  ...
  const getData = async (e) => {
    ...
    const intraURL = `https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=${textInput}&interval=60min&apikey=${process.env.REACT_APP_ALPHA_VANTAGE_API_KEY}`;
    const dailyURL = `https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=${textInput}&apikey=${process.env.REACT_APP_ALPHA_VANTAGE_API_KEY}`;
    const weeklyURL = `https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY&symbol=${textInput}&apikey=${process.env.REACT_APP_ALPHA_VANTAGE_API_KEY}`;
